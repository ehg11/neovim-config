...
vim.keymap.set("n", "<C-Up>", [[<cmd>vertical resize +5<cr>]], { desc = 'Increase Window Height' })
vim.keymap.set("n", "<C-Down>", [[<cmd>vertical resize -5<cr>]], { desc = 'Decrease Window Height' })
vim.keymap.set("n", "<C-Right>", [[<cmd>horizontal resize +2<cr>]], { desc = 'Increase Window Width'})
vim.keymap.set("n", "<C-Left>", [[<cmd>horizontal resize -2<cr>]], { desc = 'Decrease Window Width'})
